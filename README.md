...
Weekday cadence, in order: chat CLI → RAG → tokenizer (this) → tool agent → prompt lab → embedding playground → **vision caption loop (shipped)** → memory → shop-skill explainer.
